...
| File | |
| --- | --- |
| `matchday-final.html` | **The approved Matchday design.** Phases 25–28 build this; `docs/DESIGN.md` → *Matchday is a ladder with one match open on it* is the written version. Open it before touching a Matchday component. |
...
panel twice and hide one per width (fine in a flat, not in a component).
